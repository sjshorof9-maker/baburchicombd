...
export const STATUS_COLORS: Record<OrderStatus, string> = {
  [OrderStatus.PENDING]: 'bg-[#CCCCCC] text-slate-700 border-slate-200',
  ...
  [OrderStatus.DELIVERED]: 'bg-[#006400] text-white border-transparent',
  [OrderStatus.CANCELLED]: 'bg-[#8B0000] text-white border-transparent',
  [OrderStatus.RETURNED]: 'bg-orange-50 text-orange-600 border-orange-100',
  [OrderStatus.ON_HOLD]: 'bg-[#FFA500] text-white border-transparent',
};
